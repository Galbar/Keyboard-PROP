...
public class KeyboardDriver {
    public static void main(String[] args){
        ...
        int[] ass = new int[n];
        if(n%3 != 0) n+=2;
        classes.Keyboard k = new classes.Keyboard(nom,classes.enumerations.TopologyType.Squared);
        classes.Keyboard k1 =new classes.Keyboard(nom,classes.enumerations.TopologyType.Squared,c,p,ass);
