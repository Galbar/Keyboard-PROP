...
public class KeyboardDriver {
    public static void main(String[] args){
        ...
        int[] ass = new int[n];
        if(n%3 != 0) n+=2;
        classes.Keyboard k = new classes.Keyboard(nom,classes.enumerations.TopologyType.Squared,nom);
        classes.Keyboard k1 =new classes.Keyboard(nom,classes.enumerations.TopologyType.Squared,nom,c,p,ass);
        ...
        System.out.print(" tecles, la topologia per defecte: ");
